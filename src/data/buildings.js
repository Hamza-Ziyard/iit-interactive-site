export const buildings = [
  {
    ...
    floorImages: {
      parking: '/img/gp-square/inner-parking.png',
      level1: '/img/gp-square/inner-level1.png',
      level2: '/img/gp-square/inner-level2.png',
      level3: '/img/gp-square/inner-level3.png',
      level4: '/img/gp-square/inner-level4.png',
      level5: '/img/gp-square/inner-level5.png',
      level6: '/img/gp-square/inner-level6.png',
      level7: '/img/gp-square/inner-level7.png',
    },
  ...
  },
  {
    ...
    floorImages: {
      level1: '/img/java/inner-level1.png',
      level2: '/img/java/inner-level2.png',
      level3: '/img/java/inner-level3.png',
      level4: '/img/java/inner-level4.png',
    },
  ...
  },
  {
    ...
    floorImages: {
      parking: '/img/spencer/inner-level1.png',
      level1: '/img/spencer/inner-level2.png',
      level2: '/img/spencer/inner-level3.png',
      level3: '/img/spencer/inner-level4.png',
      level4: '/img/spencer/inner-level5.png',
      level5: '/img/spencer/inner-level6.png',
      level6: '/img/spencer/inner-level7.png',
      level7: '/img/spencer/inner-level8.png',
      level8: '/img/spencer/inner-level9.png',
      level9: '/img/spencer/inner-level10.png',
      level10: '/img/spencer/inner-level11.png',
      level11: '/img/spencer/inner-level12.png',
    },
