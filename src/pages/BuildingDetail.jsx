    ...
    <div className="h-full flex gap-8 p-6"> 
      ...
      <div className="relative h-full flex-1">
        <div className="h-full w-full rounded-3xl overflow-hidden shadow-inner bg-sky-100 relative flex items-center justify-center">
          ...
          {/* Floor images (shown only if section is active) */}
          {sections.map((s) => (
            <img
              key={s.key}
        ...
        {activeIndex >= 0 && (
          <div className="absolute bottom-6 left-1/2 -translate-x-1/2 flex items-center gap-3 ">
            <button
              onClick={goPrev}
              className="w-10 h-10 rounded-full bg-white shadow border border-gray-200 grid place-items-center text-gray-600 hover:bg-gray-50"
            >
      ...
      {/* Right accordion stays unchanged... */}
