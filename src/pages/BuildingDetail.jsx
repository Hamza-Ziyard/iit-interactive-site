...
function ChevronDown({ className = 'w-5 h-5' }) { return ( <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className={className}> <path fillRule="evenodd" d="M12 15.75a.75.75 0 0 1-.53-.22l-6-6a.75.75 0 1 1 1.06-1.06L12 13.94l5.47-5.47a.75.75 0 1 1 1.06 1.06l-6 6a.75.75 0 0 1-.53.22Z" clipRule="evenodd" /> </svg> ) } function CoffeeIcon({ className = 'w-5 h-5' }) { return ( <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className={className}> <path d="M4.5 6.75A.75.75 0 0 1 5.25 6h10.5a.75.75 0 0 1 .75.75 5.25 5.25 0 0 1-5.25 5.25H8.25A3.75 3.75 0 0 0 4.5 15.75v.75a2.25 2.25 0 0 0 2.25 2.25h7.5a2.25 2.25 0 0 0 2.25-2.25v-.75a6.73 6.73 0 0 0 .53-2.25h.72a2.25 2.25 0 0 0 0-4.5h-.75a6 6 0 0 0-.56-1.5.75.75 0 0 1 .56-1.2H18a3.75 3.75 0 0 1 0 7.5h-.41a6.76 6.76 0 0 1-.59 1.5v.45A3.75 3.75 0 0 1 14.25 20.25h-7.5A3.75 3.75 0 0 1 3 16.5v-.75A5.25 5.25 0 0 1 8.25 10.5h3.75a3.75 3.75 0 0 0 3.57-2.25H5.25a.75.75 0 0 1-.75-.75Z"/> </svg> ) } function UsersIcon({ className = 'w-5 h-5' }) { return ( <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className={className}> <path d="M15.75 7.5a3.75 3.75 0 1 1 7.5 0 3.75 3.75 0 0 1-7.5 0ZM1.5 7.5a3.75 3.75 0 1 1 7.5 0 3.75 3.75 0 0 1-7.5 0Zm10.5 0a3.75 3.75 0 1 1 7.5 0 3.75 3.75 0 0 1-7.5 0Zm-9 11.25a4.5 4.5 0 0 1 9 0v.75H3v-.75Zm10.5 0a4.5 4.5 0 0 1 7.5-3.422 6.708 6.708 0 0 0-2.25-.328 6.75 6.75 0 0 0-6.75 6.75v.75H13.5v-.75Z"/> </svg> ) } function BuildingIcon({ className = 'w-5 h-5' }) { return ( <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className={className}> <path d="M4.5 3A1.5 1.5 0 0 0 3 4.5v15A1.5 1.5 0 0 0 4.5 21h15a1.5 1.5 0 0 0 1.5-1.5V9a1.5 1.5 0 0 0-1.5-1.5H12V4.5A1.5 1.5 0 0 0 10.5 3h-6ZM12 9v9h7.5a.5.5 0 0 0 .5-.5V9H12Z"/> </svg> ) }
                ...
                <div className="px-5 pt-2 pb-6">
                  <ul className="space-y-6 text-gray-700">
                    {section.items.map((item, idx2) => {
                      const renderIcon = () => {
                        switch (item.icon) {
                          case 'BuildingIcon': return <BuildingIcon className="w-5 h-5 text-gray-500" />
                          case 'CoffeeIcon': return <CoffeeIcon className="w-5 h-5 text-gray-500" />
                          case 'UsersIcon': return <UsersIcon className="w-5 h-5 text-gray-500" />
                          default: return <BuildingIcon className="w-5 h-5 text-gray-500" />
                        }
                      }
                      return (
